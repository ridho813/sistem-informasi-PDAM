...
<html>
<head>
  <title>Laporan Transaksi Tagihan Bulan</title>
...
$get = mysqli_query($con, "SELECT * FROM bulan k, pelanggan s where s.id_pelanggan =k.id_pelanggan AND status='Belum Lunas'");
        $i =1;
