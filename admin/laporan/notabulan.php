...
<table cellspacing='4' style='width:550px; font-size:8pt; font-family:calibri;  border-collapse: collapse;' border='1'>
 <?php 
     ...
     $query = mysqli_query($con,"SELECT * FROM bulan k, pelanggan s where s.id_pelanggan =k.id_pelanggan  ");
         $no = 1;
        $result    =mysqli_fetch_array($query);
...
<tr>
<td align='center' >Diterima Oleh,</br></br><br><br><u> <?=$_SESSION['username'];?></u></td>
</tr>
